...
const stations = [
    ...
    { id: "citadel", label: "Citadel Road", group: "blue" },
...
const edges = [
    ...
    { id:"18", from: "end", to: "citadel", label: "228" },
    { id:"19", from: "citadel", to: "dwj", label: "347" },
    { id:"20", from: "end", to: "stronghold", label: "34" },
    { id:"21", from: "eclipse", to: "dwj", label: "164" },
    { id:"22", from: "eclipse", to: "shroom", label: "299" },
    { id:"23", from: "shroom", to: "bunny", label: "184" },
    { id:"24", from: "craglorn", to: "boner", label: "793" },
    { id:"25", from: "craglorn", to: "cobble", label: "613" },
    { id:"26", from: "meadowgrace", to: "gg", label: "849" },
    { id:"27", from: "gg", to: "bunny", label: "201" },
    { id:"28", from: "redstone", to: "dwj", label: "333" },
    { id:"29", from: "dogwood", to: "stronghold", label: "0", dashes: [10,10] },
    ...
    { id:"34", from: "cobble", to: "echell", label: "573" },
    { id:"35", from: "echell", to: "omnidye", label: "451" },
    { id:"36", from: "raid", to: "sog", label: "265" },
    { id:"37", from: "egg", to: "raid", label: "284" },
    { id:"38", from: "egg", to: "prairie", label: "638" },
    { id:"39", from: "sandshear", to: "prairie", label: "653" },
    { id:"40", from: "oasis", to: "prairie", label: "410" },
    { id:"41", from: "oasis", to: "aurora", label: "513" }, // Actually 613, reduced for balance
    { id:"42", from: "museum", to: "aurora", label: "693" }, // Actually 793
    { id:"43", from: "goat", to: "aurora", label: "321" },
    { id:"44", from: "goat", to: "eastport", label: "373" },
    { id:"45", from: "guardian", to: "aurora", label: "1154" },
    // { id:"46", from: "sandshear", to: "mesa", label: "0", dashes: [10,10] },
];
